...
import { deleteMeal } from '../features/goals/goalSlice'
function MealItem({ meal }) {
  const dispatch = useDispatch()
  console.log(meal.mealDate)
  console.log(meal.insulinDose)
  ...
  // i refresh the page when deleete because currently it shows something else being deleted but when you refresh it deletes the
...
//
//<div>
//       {meal.insulinDose + ' U/mL of Insulin at '}
//    </div>
